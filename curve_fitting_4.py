...
path = '/data/Gyrase/Pipe/Fragments_ends/Data_second_mapping/Final_data/'
...
def TU_plot(name,counts):
    ...
    plot2.plot([-7.5, -2.5], [mean_int, mean_int], color='black', lw=0.8)
    plot2.plot([-10, 0], [interval[0], interval[0]], color='black', lw=0.8)
    plot2.plot([-10, 0], [interval[1], interval[1]], color='black', lw=0.8)
    plot2.plot([-5, -5], [interval[0], interval[1]], color='black', lw=0.8)
